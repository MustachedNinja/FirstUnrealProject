...
void AFirstProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AFirstProjectCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AFirstProjectCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate", this, &AFirstProjectCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &AFirstProjectCharacter::LookUpAtRate);
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AFirstProjectCharacter::OnResetVR);
}


void AFirstProjectCharacter::OnResetVR()
{
	// If FirstProject is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in FirstProject.Build.cs is not automatically propagated
